    ...
    return (
      <Background>
        <Container style={{ marginTop: '11%' }}>
          <h1 style={{ fontWeight: '500', marginTop: '-24px' }}>Welcome to The Internship Initiative (TII)</h1>
          <Caption>Before we begin we'd like to learn a little more about you!</Caption>

          <h2 style={{ marginTop: '42px', fontWeight: '500', marginBottom: '-8px' }}> Enter School Code</h2>
          ...
          <Link to='/dashboard/my-internships' style={{ marginTop: '8px', fontWeight: '500', }}
