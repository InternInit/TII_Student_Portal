            ...
            <FooterContainer>
                ...
                <div style={{
                    ...
                    <Col>
                        ...
                        <Link to='/frequently-asked-questions' style={textStyle} className='fourteenFont'>
                            FAQ
                            </Link>
                        <Link to='/dashboard/apply-skills' style={textStyle} className='fourteenFont'>
                            Apply Skills
                        </Link>
                    </Col>
                ...
                <div style={{ marginTop: '20px' }}>
                    <span style={textStyle} className='sixteenFont'>Created by The Internship Initiative</span>
                </div>
                <div style={{ marginBottom: '30px' }}>
                    <span style={textStyle} className='fourteenFont'>© The Internship Initiative. All rights reserved. </span>
                </div>
            </FooterContainer >
        )
    }
